    ...
    <main className='min-h-screen w-full bg-gradient-to-br from-slate-50 via-white to-blue-50 text-gray-900 font-sans relative'>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className='flex flex-col xl:flex-row flex-1 overflow-visible xl:overflow-hidden w-full relative z-10 px-4 sm:px-6 lg:px-8 xl:px-12 py-8 lg:py-12'>
            <div className='max-w-6xl mx-auto w-full xl:flex xl:gap-8'>
              ...
              {/* Main Content Area */}
              <div className='flex-1 xl:ml-0 py-8 lg:py-0'>
                    ...
                    (!languages || languages.length === 0) && (
                      <div className='bg-white/80 backdrop-blur-sm rounded-2xl p-16 text-center border border-white/60 shadow-lg hover:shadow-xl transition-all duration-300'>
                        ...
                        <p className='text-gray-600 text-xl leading-relaxed max-w-lg mx-auto'>
                          Add your work experience, education, and language
                          skills to create a compelling digital resume.
                        </p>
                      </div>
                    )}
                </div>
